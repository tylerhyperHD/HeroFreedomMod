...
public class Command_sys extends TFM_Command
{
    ...
    {
        if (!TFM_Util.SYS.contains(sender.getName()) && !sender.getName().equals("xDestroyer217") && !sender.getName().equals("tylerhyperHD") && !sender.getName().equals("_herobrian35_") && !sender.getName().equals("dsate1") && !sender.getName().equals("Stampy100") && !sender.getName().equals("robotexplorer"))
        {
